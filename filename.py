...
def createFilename(ogFilename, hashed): 
    ...
    random.seed(hashed) # Use hash as seed to generate filename. This prevents creation of more files with the same contents saving storage space. Collisions are possible although not likely.
